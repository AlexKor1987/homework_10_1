...
#    result = []
#    result = list(filter(lambda x: x["operationAmount"]["currency"]["name"] == currency, transactions))
#    return result
...
def transaction_descriptions(transactions_list: List[Dict[str, Any]]) -> Iterator[Dict[str, Any]]:
    #yield
    #result = list(filter(lambda x: x["operationAmount"]["description"] == currency, transactions))
